...
\subsection{ A centered image (basic)}
...
\subsection{ Floats with different placement specifiers}
...
\subsection{ Forcing exact placement with \texttt{[H]}}
...
\subsection{ \texttt{\textbackslash textwidth} vs \texttt{\textbackslash linewidth}}
...
\subsection{ What if \texttt{\textbackslash label} is before \texttt{\textbackslash caption}?}
...
\subsection{ Equation labels: inside vs after the environment}
\begin{equation}
e^{i\pi}+1 = 0
\label{eq:inside}
\end{equation}
